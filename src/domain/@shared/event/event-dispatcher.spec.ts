...
import SendMessageWhenCustomerIsCreated from "../../customer/event/handler/send-message-when-customer-is-created.handler";
import SendSecondMessageWhenCustomerIsCreated from "../../customer/event/handler/send-second-message-when-customer-is-created.handler";
